...
REM echo     // requires /* transitive */ 依存する外部モジュール; >> %src_dir%t_panda.compiler\module-info.java
REM echo     // opens 外部モジュールからリフレクションでアクセスを許可するパッケージ; >> %src_dir%t_panda.compiler\module-info.java
REM echo     // exports 外部モジュールからアクセスを許可するパッケージ; >> %src_dir%t_panda.compiler\module-info.java
REM echo } >> %src_dir%t_panda.compiler\module-info.java
